      ...
      <Grid item xs={4}>
        <Fade bottom>
          <div className="logindiv">
            ...
            <form method="POST">
              <label>Username <span className="label-span">*</span></label>
            ...
            <div>
              <h5 className="h5-d">Don't have account? <a href="/register">Login</a></h5>
            </div>
            <hr />
            <div className="social-login">
              <button className="google-button">
                <img className="google-icon" src={require('../icons/google.png')} />Register with Google</button>
            </div>
          </div>
        </Fade>
      </Grid>
